...
<div class="card" style="padding:20px;">
       ...
       if(isset($_GET['id'])){
           ...
           $update = mysqli_query($dbc, "UPDATE `users` SET `status` = 'unapproved' WHERE `id` = '$id' ");
...
<script>
    ...
    swal({
          text: "Success",
  title: "User has been Unapproved  ",
 ...
 <?php
       ...
       ?>
        ...
        <br><br>
        <h5> User has been Unapproved.</h5> <br>
          <a href="manageusers.php" class="btn btn-success"> Go back to previous page. </a>
    </center>
