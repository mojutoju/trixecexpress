              ...
              <div class="card">
                    ...
                    <div class="table-responsive table-hover">
                      <table class="table">
                        ...
                        <?php
$select = mysqli_query($dbc,"SELECT * FROM `requests` WHERE 1 ORDER BY sendername, confirmation ASC ");
...
<div class="dropdown-menu">
  ...
  <a class="dropdown-item" href="uncompletedrequests.php?requestid=<?php echo $requestid; ?>">Uncompleted</a>
    <a class="dropdown-item" href="alldeliveries.php?requestid=<?php echo $requestid; ?>">Delete</a>
</div>
<!-- Basic dropdown -->  </td>
