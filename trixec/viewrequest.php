...
$email = $rows['email'];
   ...
   $pic = mysqli_query($dbc, "SELECT * FROM profileimages WHERE email= '$email' ");
     ...
     $files = $row['file'];
         $imageid = $row['imageid'];     
           ...
           $s = mysqli_query($dbc,"SELECT * FROM `users` WHERE email = '$email'  ");
...
<div class="card">
    ...
    <hr>
    <p>  <i class="fa fa-phone"></i> <a href="tel:<?php echo $phonenos; ?>" style="color:black;"> <?php echo $phonenos; ?> </a> </p>
    <hr>
        </div>
        ...
        <div class="col-md-6 ">
            ...
            <hr>
            	...
            	<p> Pickup Location : <?php echo $pickup; ?> |  Dropoff Location : <?php echo $dropoff; ?>  </p>
