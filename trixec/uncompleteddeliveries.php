...
<script>
 ...
 setTimeout(function () {
       window.location.href = "uncompleteddeliveries.php"; //will redirect to your blog page (an ex: blog.html)
    }, 2000);
</script>  
 ...
 <?php
       ...
       <div class="page-header">
             ...
             <h3 class="page-title">
                ...
                </span> Uncompleted Deliveries </h3>
              ...
              <div class="card">
                    ...
                    <div class="table-responsive table-hover">
                      <table class="table">
                        ...
                        <?php
$select = mysqli_query($dbc,"SELECT * FROM `requests` WHERE confirmation = 'Uncompleted' ORDER BY sendername, confirmation ASC ");
...
<div class="dropdown-menu">
  ...
  <a class="dropdown-item" href="uncompletedrequests.php?requestid=<?php echo $requestid; ?>">Uncompleted</a>
    <a class="dropdown-item" href="uncompleteddeliveries.php?requestid=<?php echo $requestid; ?>">Delete</a>
</div>
<!-- Basic dropdown -->  </td>
