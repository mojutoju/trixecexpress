...
<div class="card" style="padding:20px;">
       ...
       if(isset($_GET['requestid'])){
           ...
           $update = mysqli_query($dbc, "UPDATE `requests` SET `confirmation` = 'Uncompleted' WHERE `requestid` = '$id' ");
...
<script>
    ...
    swal({
          text: "Success",
  title: "Requests has been updated to Uncompleted  ",

  icon: "success",
  button: "Close",
});
 setTimeout(function () {
       window.location.href = "alldeliveries.php"; //will redirect to your blog page (an ex: blog.html)
    }, 5000);
</script>  
 ...
 <?php
       ...
       ?>
        ...
        <br><br>
        <h5> Request has been updated to Uncompleted.</h5> <br>
          <a href="alldeliveries.php" class="btn btn-success"> Go back to previous page. </a>
    </center>
