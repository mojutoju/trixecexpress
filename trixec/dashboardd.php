...
<div class=" border-right" id="sidebar-wrapper" style="background-color:white; ">
  ...
  <a data-toggle="tab" href="#panel10" role="tab" class="list-group-item list-group-item-action" style="font-weight: bold; "> <i class="	fa fa-signal"></i> General Overview </a>
    <a data-toggle="tab" href="#panel11" role="tab" class="list-group-item list-group-item-action" style="font-weight: bold; "> 
    <i class="fa fa-user"></i> Orders Setup </a>
    
       <a data-toggle="tab" href="#panel12" role="tab" class="list-group-item list-group-item-action" style="font-weight: bold; "> 
    <i class="fa fa-group"></i> Manage Orders </a>
...
?>
      ...
      if(isset($_GET['id'])){
          ...
          $delete = mysqli_query($dbc, "DELETE FROM `requests` WHERE id = '$id' ");
...
<div class="tab-pane fade in show active" id="panel10" role="tabpanel">
       <h6 style="font-weight:800; text-align:left;"> General Overview </h6>
        <hr>
  ...
  <div class="row">
      ...
      <div class="col-md-4 mb-4">
        ...
        <span class="count-numbers"> <?php echo reset($count); ?> </span>
        <span class="count-name">Orders/Requests</span>
      </div>
        ...
        <i class="fa fa-money"></i>
          <?php
          $sum = mysqli_query($dbc, "SELECT  sum(amount) AS total FROM `requests` ");
        
$row = mysqli_fetch_assoc($sum); 
$total = $row['total'];
        
          ?>
        <span class="count-numbers"> N<?php echo number_format($total); ?> </span>
        <span class="count-name">Profit(s)</span>
      </div>
...
<div class="tab-pane fade in" id="panel11" role="tabpanel">
       <h6 style="font-weight:800; text-align:left;"> Orders Setup </h6>
        <hr>
  ...
  if(isset($_POST['requests'])){
      ...
      $insert = mysqli_query($dbc, "INSERT INTO `requests` VALUES (NULL, '$sendername', '$item', '$phoneno', '$amount', '$description', '$address', '$state', '$receivername', '$receiverno', '$receiveraddress', '$receiverstate', '$options' , '$status', now()) ");
...
<script>
  ...
  <form name="requests" action="dashboard.php" method="POST">
      ...
      <div class="form-group">
          ...
          <input type="text" name="sendername" class="form-control" style="font-size:13px;" placeholder="Sender's Name">
      ...
      <div class="form-group">
          ...
          <input type="text" name="item" class="form-control" style="font-size:13px;" placeholder="Item Name">
      ...
      <div class="col-md-4 mb-3">
       ...
       <input type="text" class="form-control"  placeholder="Amount (N)" required=""  onkeydown="return ( event.ctrlKey || event.altKey || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false) 
                    || (95<event.keyCode && event.keyCode<106)
                    || (event.keyCode==8) || (event.keyCode==9) 
                    || (event.keyCode>34 && event.keyCode<40) 
     ...
     <div class="col-md-8 mb-3">
        ...
        <textarea class="form-control" name="description" placeholder="Item Description" style="font-size:13px;" required></textarea>
      </div>
      ...
      <div class="col-md-8 mb-3">
        ...
        <textarea class="form-control" name="address" placeholder="Address" style="font-size:13px;" required></textarea>
      </div>
...
<select name="state" id="state" class="form-control"  style="font-size: 13px;" >
  ...
  <div class="row">
      ...
      <div class="form-group">
          ...
          <input type="text" name="receivername" class="form-control" style="font-size:13px;" placeholder="Receiver's Name">
       ...
       <div class="col-md-4 mb-3">
               <div class="form-group">
              <input type="text" class="form-control" name="receiverno" placeholder="Phone number" required=""  onkeydown="return ( event.ctrlKey || event.altKey || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false) 
                    || (95<event.keyCode && event.keyCode<106)
                    || (event.keyCode==8) || (event.keyCode==9) 
                    || (event.keyCode>34 && event.keyCode<40) 
                    || (event.keyCode==46) )"  style="font-size: 13px;">
        ...
        <textarea class="form-control" name="receiveraddress" placeholder="Address" style="font-size:13px;" required></textarea>
      </div>
...
<select name="receiverstate" id="state" class="form-control"  style="font-size: 13px;" >
  ...
  <div class="form-group">
          <label style="font-size:13px;"> Who would make Payment ? </label>
  <select name="options" class="form-control" style="font-size:13px;" required>
  ...
  <select name="status" class="form-control" style="font-size:13px;" required>
    ...
    <input type="submit" name="requests" value="Submit" class="btn btn-danger">  
  </form>
  </div>
...
<div class="tab-pane fade in" id="panel12" role="tabpanel">
       <h6 style="font-weight:800; text-align:left;"> Manage Orders </h6>
        <hr>
        
        
	<input type="search" class="light-table-filter form-control" data-table="order-table" placeholder="Search for details " style="font-size:13px;" >
        
    <div class="table-responsive table-striped table-hover">
        <table id="dtBasicExample" class="order-table table" width="100%">
  <thead>
    <tr>
      <th class="th-sm">Senders
      </th>
  ...
  <?php
  $request = mysqli_query($dbc,"SELECT * FROM `requests` WHERE 1  ");
...
$newDate = date("D-d-F-Y", strtotime($date));
  ...
  <tbody>
    <tr>
      ...
      <td> <a href="edit.php?id=<?php echo $id; ?>" class="btn btn-primary btn-sm"> Edit </a> </td>
      <td>  <a  onclick="return confirm('Are you sure you want to delete this data ?');" href="dashboard.php?id=<?php echo $id; ?>" class="btn btn-danger btn-sm"> <i class="fa fa-trash"></i> </a> </td>
    </tr>
 <?php $r++; }} ?>
  </tbody>
