...
<div class="card" style="padding:20px;">
       ...
       if(isset($_GET['requestid'])){
           ...
           $update = mysqli_query($dbc, "UPDATE `requests` SET `confirmation` = 'Completed' WHERE `requestid` = '$id' ");
...
<script>
    ...
    swal({
          text: "Success",
  title: "Requests has been updated to Completed  ",
 ...
 <?php
       ...
       ?>
        ...
        <br><br>
        <h5> Request has been updated to Completed.</h5> <br>
