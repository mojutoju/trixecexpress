...
<?php
if(isset($_GET['walletid']) && isset($_GET['email']) && isset($_GET['amount']) ){
...
$amount = $_GET['amount'];
    ...
    $cart_url = "https://trixecexpress.com/users/processwallet.php";
    $cart_url_www = "https://www.trixecexpress.com/users/processwallet.php";
...
$insert = mysqli_query($dbc, "INSERT INTO `wallet` VALUES (NULL, '$walletid', '$email', '$amount', now()) ");
if($insert){
...
<div class="card" style="padding:30px;">
    ...
    <center>
        ...
        <br><br>
        <h5> E-Wallet has been funded successfully.</h5>
    </center>
</div>
