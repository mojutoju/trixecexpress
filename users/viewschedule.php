...
Nigeria </title>
      ...
      <div class="main-panel">
       ...
       <div class="page-header">
          ...
          <h3 class="page-title">
                ...
                </span> Pay Scheduled Delivery Requests  </h3>
 ...
 <hr>
           ...
           <div class="card">
               ...
               <div class="card-header"> Confirm Scheduled Processing Book Requests</div>
			...
			<hr>
                   	 ...
                   	 <script src="https://api.ravepay.co/flwv3-pug/getpaidx/api/flwpbf-inline.js"></script>
                                    ...
                                    <button type="button" class="btn btn-success" onClick="payWithRave()">Pay Direct </button>
                                    	<a href="schedulewalletpayment.php?requestid=<?php echo $requestid; ?>&amount=<?php echo $amount; ?>" class="btn btn-danger"> Pay with E-Wallet </a>
                                        ...
                                        var x = getpaidSetup({
                                            ...
                                            callback: function(response) {
                                                ...
                                                if (
                                                    ...
                                                    window.location.href = "scheduledirectpayment.php?requestid=<?php echo $requestid."&amount=".$amount; ?> ";     // redirect to a success page
                                                } else {
