...
.view,body,html{height:100%}@media (max-width:740px){.full-page-intro{height:1000px}}.carousel{height:50%}.carousel .carousel-inner,.carousel .carousel-inner .active,.carousel .carousel-inner .carousel-item{height:100%}@media (max-width:776px){.carousel{height:100%}}.navbar{background-color:rgba(0,0,0,.3)}.page-footer,.top-nav-collapse{background-color:#1C2331}@media only screen and (max-width:768px){.navbar{background-color:#1C2331}}
    ...
    <body>
        ...
        <!-- Footer -->
<footer class="page-footer font-small  pt-4" style="background:#C81515; ">
  ...
  <div class="container text-center text-md-left">
    ...
    <div class="row">
      ...
      <div class="col-md-6 mt-md-0 mt-3">
        ...
        <!-- Content -->
        <h5 class="text-uppercase font-weight-bold">Trixec Express</h5>
        <p>MOST TRUSTED AND RELIABLE LOGISTICS COMPANY IN
NIGERIA
</p>
      ...
      <div class="col-md-3 mb-md-0 mb-3">
        ...
        <!-- Links -->
        <h5 class="text-uppercase font-weight-bold">About Trixec Express</h5>
      ...
      <div class="col-md-3 mb-md-0 mb-3">
        ...
        <!-- Links -->
        <h5 class="text-uppercase font-weight-bold">Join Us </h5>

        <ul class="list-unstyled">
          <li>
            <a style="color:white;" href="users/signup.php">Become a User </a>
          </li>
          <li>
            <a style="color:white;" href="#">Become a Dispatch Rider </a>
          </li>
  ...
  <!-- Copyright -->
  <div class="footer-copyright text-center py-3" style="background:black;">© 2020 Copyright:
    <a style="color:white;" href="index.php"> Trixec Express </a>
  </div>
  <!-- Copyright -->
