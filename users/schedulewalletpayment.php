...
$requestid = $_GET['requestid'];
    ...
    $cart_url = "https://trixecexpress.com/users/viewschedule.php?requestid=$requestid";
    $cart_url_www = "https://www.trixecexpress.com/users/viewschedule.php?requestid=$requestid";
...
<div class="card" style="padding:30px;">
    ...
    <center>
        ...
        <br>
        <br>
        <h4>Insufficient Funds.</h4> <br>
        <a href="addwallet.php" class="btn btn-success"> Fund Wallet </a>
    </center>
</div>
...
<?php
 ...
 $insert = mysqli_query($dbc, "UPDATE `requests` SET `paymenttype` = 'E-wallet Payment', `paymentstatus` = 'Paid'  WHERE `requestid` = '$requestid' AND `email` = '".$_SESSION['login']."' ");
if($insert){
...
<div class="card" style="padding:30px;">
    ...
    <center>
        ...
        <h5> Your request has been booked successfully.</h5> <br>
          <a href="schedulerequests.php" class="btn btn-success"> Click here to book another request. </a>
    </center>
</div>
...
$update = mysqli_query($dbc, "UPDATE `wallet` SET `amount`= $sum - $amount   WHERE email = '".$_SESSION['login']."' ");
if($update){
