      ...
      <div class="main-panel">
       ...
       <div class="page-header">
            ...
            <hr>
                ...
                <input type="text" class="form-control" style="font-size:13px;" id="myInput" placeholder="Search for all invoices...">
              ...
              <div class="card">
                    ...
                    <div class="table-responsive table-hover">
                      <table class="table">
                        ...
                        <?php
$select = mysqli_query($dbc,"SELECT * FROM `requests` WHERE email = '".$_SESSION['login']."'   ");
...
$confirmation = $rows['confirmation'];
    ?>
                        ...
                        <tbody id="myTable">
                            ...
                            <td> <a href="viewinvoice.php?requestid=<?php echo $requestid; ?>" class="btn btn-success btn-sm"> View Invoice </a></td>
