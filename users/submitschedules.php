...
isset($_GET['description']) && isset($_GET['sendername']) && isset($_GET['senderphoneno']) && isset($_GET['senderaddress']) && isset($_GET['receivername']) && isset($_GET['receiverphoneno']) && isset($_GET['receiveraddress']) && isset($_GET['paymenttype']) 
&& isset($_GET['paymentstatus']) && isset($_GET['confirmation']) ){
 ...
 $daterequest = $_GET['daterequest'];
    ...
    $cart_url = "https://trixecexpress.com/users/scheduleprocess.php";
    $cart_url_www = "https://www.trixecexpress.com/users/scheduleprocess.php";
...
<div class="card" style="padding:30px;">
    ...
    <center>
        ...
        <br><br>
        <h5> Your request has been scheduled successfully.</h5> <br>
          <a href="dashboard.php" class="btn btn-success"> Kindly go to the scheduling deliveries page to make payment. </a>
    </center>
</div>
