...
Nigeria </title>
      ...
      <div class="main-panel">
       ...
       <div class="page-header">
          ...
          <h3 class="page-title">
                ...
                </span> Schedule Requests Booking  </h3>
 ...
 <hr>
     ...
     <form name="requests" action="scheduleprocess.php" method="POST">
         
         
     
                <label style="font-size:13px;"> Date of Schedule </label>
                <input type="date" class="form-control" required id="txtDate"  name="daterequest" placeholder="Select Date of Schedule" style="font-size:13px;">
  ...
  <div class="row">
      ...
      <div class="col-md-6 mb-3">
       ...
       <div class="col-md-6 mb-3">
          ...
          <input type="hidden"  name="paymenttype" value="None" class="form-control"  style="font-size:13px;">
          <input type="hidden"  name="paymentstatus" value="Not Paid" class="form-control"  style="font-size:13px;">
          <input type="hidden"  name="confirmation" value="Pending" class="form-control"  style="font-size:13px;">
